 ...
 */
class ContasPagarCriteria extends BaseCriteria
{
    ...
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        $model = $model->select(
            ...
            ->where('lancamento_financeiros.tipo', TipoLancamento::SAIDA);
        ...
        if (isset($this->whereArray[self::FILTRO_NAME]['financeiro.lancamento_financeiros.parent_id'])) {
            ...
            $model->where('lancamento_financeiros.parent_id', $parent_id);
        }
        if (
